...
function createSceneObjects() {
    ...
    decalMaterial.albedoTexture = new BABYLON.Texture("/assets/squiz.png");
    ...
    groundMat.albedoTexture = new BABYLON.Texture("/assets/floor1.jpg", scene);
    ...
    wallMat.albedoTexture = new BABYLON.Texture("/assets/wood1.jpg", scene);
...
function importModelAsync(model) {
    Promise.all([
        ...
        BABYLON.SceneLoader.ImportMeshAsync(null, "/assets/" , model, scene).then(function (result) {
            ...
            observable.add((collisionEvent) => {
                ...
                // {
                //     burst(collisionEvent.collidedAgainst.transformNode, "/assets/smoke.png");
                // }
...
function setLighting() {
    hdrTexture = BABYLON.CubeTexture.CreateFromPrefilteredData("/assets/environment_19.env", scene);
